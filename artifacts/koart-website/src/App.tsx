...
function Logo({ inverse = false }: { inverse?: boolean }) {
  return (
    ...
    >
      <span
        className={`relative grid h-8 w-8 place-items-center rounded-[9px] border-2 ${inverse ? 'border-[#ff3131]' : 'border-[#171717]'}`}
      >
        <span className={`h-2.5 w-2.5 rounded-full ${inverse ? 'bg-[#ff3131]' : 'bg-[#ff3131]'}`} />
        <span className={`absolute -right-1 -top-1 h-2.5 w-2.5 rounded-full border-2 ${inverse ? 'border-[#171717] bg-[#ff3131]' : 'border-[#f7f2eb] bg-[#171717]'}`} />
      </span>
  ...
  return (
    <main id="top" className="koart-shell grain text-[#171717]">
      ...
      <section className="relative overflow-hidden bg-[#171717] pb-16 pt-[132px] text-[#f7f2eb] md:pb-24 md:pt-[170px]">
        ...
        <div className="absolute -right-20 top-20 h-72 w-72 rounded-full bg-[#ff3131]/10 blur-3xl" />
        <div className="relative mx-auto max-w-[1240px] px-5 sm:px-8">
          <div className="grid items-end gap-14 lg:grid-cols-[1.05fr_.95fr] lg:gap-10">
            <div>
              <div className="reveal-up mb-8 flex items-center gap-3 text-[11px] font-bold uppercase tracking-[0.19em] text-[#ff3131]">
              ...
              <h1 className="font-display reveal-up reveal-delay-1 max-w-[750px] text-[clamp(3.7rem,8.5vw,8.3rem)] font-semibold leading-[.86]">
                The business
                <span className="block text-[#ff3131]">behind the</span>
                business.
              </h1>
              ...
              <div className="reveal-up reveal-delay-3 mt-9 flex flex-wrap items-center gap-3">
                <a
                  ...
                  className="group inline-flex items-center gap-3 rounded-full bg-[#ff3131] px-5 py-3.5 text-sm font-bold text-[#171717] transition-transform hover:-translate-y-1"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-full border border-[#f7f2eb]/25 px-5 py-3.5 text-sm font-semibold text-[#f7f2eb] transition-colors hover:border-[#ff3131] hover:text-[#ff3131]"
                >
            ...
            <div className="relative mx-auto min-h-[370px] w-full max-w-[490px] lg:min-h-[500px]">
                <div className="absolute right-0 top-2 w-[82%] rounded-[22px] border border-[#f7f2eb]/15 bg-[#262626] p-4 shadow-2xl shadow-black/20 float-card">
                 <div className="mb-5 flex items-center justify-between border-b border-[#f7f2eb]/10 pb-3">
                  <div className="flex items-center gap-2">
                   ...
                   <span className="font-mono text-[10px] text-[#ff3131]">LIVE</span>
                </div>
                  ...
                  {[
                    ...
                    <div key={label as string} className="rounded-xl bg-[#171717] p-3">
                      <div className="mb-2 flex items-center justify-between text-[11px]">
                        ...
                        <span className="text-[#ff3131]">{status}</span>
                      </div>
                      <div className="h-1.5 rounded-full bg-[#f7f2eb]/10">
                        <div className="h-full rounded-full bg-[#ff3131]" style={{ width: `${width}%` }} />
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="absolute bottom-5 left-0 w-[62%] rounded-[20px] bg-[#ff3131] p-5 text-[#171717] shadow-xl shadow-black/20">
              ...
              <div className="absolute bottom-0 right-1 rounded-full border border-[#ff3131]/50 bg-[#171717] px-3 py-2 font-mono text-[10px] uppercase tracking-widest text-[#ff3131]">
                Built for momentum →
              </div>
            </div>
          </div>
      ...
      <section id="services" className="mx-auto max-w-[1240px] px-5 py-24 sm:px-8 md:py-36">
        <div className="grid gap-12 lg:grid-cols-[.72fr_1.28fr] lg:gap-20">
          <div className="lg:sticky lg:top-32 lg:self-start">
            <div className="mb-5 font-mono text-[11px] font-bold uppercase tracking-[0.18em] text-[#ff3131]">01 / The full solution</div>
            ...
            <a href="#contact" data-testid="link-services-cta" className="group mt-8 inline-flex items-center gap-2 text-sm font-bold underline decoration-[#ff3131] decoration-2 underline-offset-4">
      ...
      <section id="fit" className="border-y border-[#171717]/10 bg-[#e9e1d5]">
        <div className="mx-auto max-w-[1240px] px-5 py-24 sm:px-8 md:py-32">
          <div className="mb-16 flex flex-col justify-between gap-6 md:flex-row md:items-end">
            <div>
              <div className="mb-5 font-mono text-[11px] font-bold uppercase tracking-[0.18em] text-[#ff3131]">02 / Built around you</div>
      ...
      <section className="bg-[#171717] text-[#f7f2eb]">
        <div className="mx-auto max-w-[1240px] px-5 py-24 sm:px-8 md:py-32">
          <div className="grid gap-16 lg:grid-cols-[.8fr_1.2fr] lg:gap-24">
            <div>
              <div className="mb-5 font-mono text-[11px] font-bold uppercase tracking-[0.18em] text-[#ff3131]">03 / How we work</div>
              <h2 className="font-display max-w-[470px] text-[clamp(3rem,5.8vw,6.4rem)] font-semibold leading-[.86]">Clear thinking.<br /><span className="text-[#ff3131]">Useful output.</span></h2>
      ...
      <section className="mx-auto max-w-[1240px] px-5 py-24 sm:px-8 md:py-36">
        <div className="mb-14 flex items-end justify-between gap-6">
          <div>
            <div className="mb-5 font-mono text-[11px] font-bold uppercase tracking-[0.18em] text-[#ff3131]">04 / The useful difference</div>
        ...
        <div className="grid gap-4 md:grid-cols-12">
          ...
          <div className="flex min-h-[240px] flex-col justify-between rounded-[26px] bg-[#171717] p-7 text-[#f7f2eb] md:col-span-7 md:p-9">
            <div className="flex items-start justify-between">
              <span className="font-mono text-[11px] uppercase tracking-widest text-[#ff3131]">The KOart principle</span>
              <Sparkles size={22} className="text-[#ff3131]" />
            </div>
        ...
        <div className="mx-auto grid max-w-[1240px] gap-12 px-5 py-20 sm:px-8 md:py-28 lg:grid-cols-[.9fr_1.1fr] lg:gap-24">
          <div>
            ...
            <div className="mt-12 flex items-center gap-3 text-sm font-semibold">
              <span className="grid h-9 w-9 place-items-center rounded-full bg-[#171717] text-[#ff3131]"><Send size={16} /></span>
          ...
          <div className="rounded-[26px] bg-[#f7f2eb] p-6 shadow-xl shadow-[#171717]/10 sm:p-9">
            {submitted ? (
              <div className="flex min-h-[470px] flex-col justify-between">
                <div>
                  <div className="mb-7 grid h-14 w-14 place-items-center rounded-full bg-[#ff3131]"><Check size={27} /></div>
                ...
                <button type="button" data-testid="button-send-another" onClick={() => { setSubmitted(false); setForm(initialForm); }} className="inline-flex w-fit items-center gap-2 text-sm font-bold underline decoration-[#ff3131] decoration-2 underline-offset-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <label className="block">
                  <span className="mb-2 block text-[12px] font-bold uppercase tracking-[0.1em] text-[#171717]/55">A little about the project <span className="text-[#ff3131]">*</span></span>
                  <textarea
                    required
                    name="message"
                    value={form.message}
                ...
                <button type="submit" data-testid="button-submit-quote" className="group flex w-full items-center justify-between rounded-xl bg-[#171717] px-5 py-4 text-left text-sm font-bold text-[#f7f2eb] transition-transform hover:-translate-y-0.5">
                  Send my enquiry <ArrowUpRight size={19} className="magnetic-arrow text-[#ff3131]" />
                </button>
        ...
        <div className="mx-auto max-w-[1240px] px-5 py-12 sm:px-8 md:py-16">
          <div className="flex flex-col justify-between gap-10 border-b border-[#f7f2eb]/15 pb-12 md:flex-row md:items-end">
            ...
            <div className="flex flex-wrap gap-x-7 gap-y-3 text-sm text-[#f7f2eb]/65">
              <a href="#build" data-testid="link-footer-build" className="transition-colors hover:text-[#ff3131]">KOart Build</a>
              <a href="#studio" data-testid="link-footer-studio" className="transition-colors hover:text-[#ff3131]">KOart Studio</a>
              <a href="#contact" data-testid="link-footer-contact" className="transition-colors hover:text-[#ff3131]">Get in touch</a>
              <a href="#top" data-testid="link-footer-top" className="transition-colors hover:text-[#ff3131]">Back to top ↑</a>
            </div>
          </div>
...
function Field({ label, name, value, onChange, required = false }: { label: string; name: string; value: string; onChange: (value: string) => void; required?: boolean }) {
  return (
    <label className="block">
      <span className="mb-2 block text-[12px] font-bold uppercase tracking-[0.1em] text-[#171717]/55">{label} {required && <span className="text-[#ff3131]">*</span>}</span>
...
function SelectField({ label, name, value, onChange, options }: { label: string; name: string; value: string; onChange: (value: string) => void; options: string[] }) {
  return (
    <label className="relative block">
      <span className="mb-2 block text-[12px] font-bold uppercase tracking-[0.1em] text-[#171717]/55">{label} <span className="text-[#ff3131]">*</span></span>
  ...
  return (
    <article id={id} className={`service-card group rounded-[26px] border p-7 sm:p-9 ${isLime ? 'border-[#171717]/15 bg-[#f7f2eb]' : 'border-[#171717]/10 bg-[#171717] text-[#f7f2eb]'}`}>
      ...
      <div className="mt-16 grid gap-9 md:grid-cols-[.8fr_1.2fr] md:items-end">
        <div>
          <p className={`mb-3 font-mono text-[10px] font-bold uppercase tracking-[0.18em] ${isLime ? 'text-[#171717]/55' : 'text-[#ff3131]'}`}>{eyebrow}</p>
        ...
        <div>
          ...
          <ul className="mt-7 grid gap-2.5">
            {items.map((item) => <li key={item} className="flex items-center gap-2 text-[13px] font-semibold"><Check size={14} className="text-[#ff3131]" />{item}</li>)}
          </ul>
        </div>
      </div>
      <div className={`mt-10 flex items-center gap-2 text-[12px] font-bold ${isLime ? 'text-[#171717]' : 'text-[#ff3131]'}`}>Explore this lane <ArrowUpRight size={15} className="magnetic-arrow" /></div>
    </article>
  );
}
...
function AudienceCard({ number, title, copy, icon }: { number: string; title: string; copy: string; icon: ReactNode }) {
  return (
    <article className="group min-h-[310px] rounded-[22px] border border-[#171717]/12 bg-[#f7f2eb] p-7 transition-transform hover:-translate-y-1.5 sm:p-8">
      <div className="flex items-start justify-between">
        <span className="font-mono text-[11px] font-bold text-[#ff3131]">{number}</span>
        <span className="grid h-9 w-9 place-items-center rounded-full bg-[#ff3131] text-[#171717]">{icon}</span>
      </div>
      <div className="mt-20">
...
function ProcessRow({ step, title, copy, icon }: { step: string; title: string; copy: string; icon: ReactNode }) {
  return (
    <div className="group grid gap-4 py-7 sm:grid-cols-[55px_1fr_36px] sm:items-center">
      ...
      <span className="hidden text-[#ff3131] transition-transform group-hover:translate-x-1 sm:block">{icon}</span>
    </div>
  );
}
...
function Stat({ value, label }: { value: string; label: string }) {
  return (
    <div>
      <div className="font-display text-[2.9rem] font-semibold leading-none text-[#ff3131]">{value}</div>
